...
import { Smartphone, Upload, Check, Tv, Laptop, Cpu } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col pt-16 md:pt-24 pb-24">
      <div className="flex-1 container max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Cadastre seu Dispositivo para Descarte</h1>
          <p className="text-muted-foreground max-w-2xl">
            Preencha as informações abaixo sobre seu dispositivo eletrônico. Após o cadastro, você poderá encontrar o ponto de coleta mais próximo.
          </p>
        </motion.div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="other">Outro dispositivo eletrônico</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="device-name"
                      placeholder="Ex: iPhone 11, Samsung TV, Dell Laptop"
                      value={deviceName}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="device-image">Foto do dispositivo (opcional)</Label>
                  ...
                  <Button 
                    ...
                    disabled={!deviceName || isSubmitting || isSuccess}
                  >
                    {isSubmitting ? (
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Seu descarte responsável ajuda o meio ambiente! A reciclagem de dispositivos eletrônicos pode:
              </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <p className="text-sm">Economizar energia suficiente para alimentar centenas de dispositivos</p>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 rounded-full bg-eco-green/20 flex items-center justify-center mr-3 mt-0.5">
                    <Check className="h-3 w-3 text-eco-green" />
